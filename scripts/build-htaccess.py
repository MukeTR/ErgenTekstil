...
lines = [
    ...
    "RewriteRule ^ https://www.ergentekstil.com%{REQUEST_URI} [L,R=301]",
    "",
    "# Eski WordPress görselleri (/wp-content/uploads) yerinde tutulur; oradaki PHP asla çalışmaz",
    "RewriteRule ^wp-content/.*\\.(php\\d?|phtml|phar)$ - [F,L]",
    "",
    "# Eski WordPress/AIOSEO site haritaları → yeni tek sitemap",
    "RewriteRule ^(sitemap_index|wp-sitemap|sitemap-index|[a-z_]+-sitemap\\d*)\\.xml$ /sitemap.xml [L,R=301]",
    "",
